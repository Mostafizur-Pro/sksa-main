                ...
                <tr class="bg-base-200 @if ($data->email === $user->email) bg-green-100 @endif">
                    ...
                    <th>
                        ...
                        <div class="flex space-x-2">
                            <a href="{{ url('edit-profile', $user->id) }}" class="btn bg-blue-500 rounded-none hover:bg-blue-700 text-white">
                            ...
                            <form method="POST" action="{{ route('deleteUser', $user->id) }}">
                                @csrf
                                @method('DELETE')
                                <button class="btn bg-red-500 hover:bg-red-700 text-white rounded-none">
                                    <svg xmlns="http://www.w3.org/2000/svg" height="16px" viewBox="0 0 512 512">
                    ...
                    <th>
                        ...
                        <form method="POST" action="{{ route('makeUser', $user->id) }}">
                            ...
                            <button class="btn bg-green-500 hover:bg-green-700 text-white font-bold  rounded-none">Make User</button>
                            @endif
                        </form>
                        @else
                        ...
                        <form method="POST" action="{{ route('makeAdmin', $user->id) }}">
                            ...
                            <button class="btn bg-blue-500 hover:bg-blue-700 text-white font-bold  rounded-none">Make Amin</button>
                        </form>
