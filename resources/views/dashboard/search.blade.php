        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <form class="flex items-center" action="{{ route('search') }}" method="GET">
                <div class="mb-4">
                    ...
                    <input type="text" id="search" name="search" value="{{$searchTerm}}" class="w-full border rounded py-2 px-3 text-gray-800">
                </div>
                <div class="mt-4">
                ...
                <tbody>
                    <tr class="bg-base-200 @if ($data->email === $user->email) bg-green-100 @endif">
                        ...
                        <th>
                            ...
                            <div class="flex ">
                                <button onclick="my_modal_5.showModal()" class="btn btn-sm bg-green-500  hover:bg-green-700 text-white">
