    ...
    <div id="slide2" class="carousel-item relative w-full">
        <div class="hero mx-6 md:mx-16 lg:mx-24 xl:mx-32">
            <div class="hero-content flex-col-reverse lg:flex-row-reverse">
                ...
                <img src="assets/slide/slide2.jpg" class="rounded-lg w-full md:w-1/2 lg:w-2/5 xl:w-1/2" alt="slide2" />
            </div>
        </div>
        <div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
            <a href="#" class="btn bg-red-500 hover:bg-red-700 text-white btn-circle" onclick="prevSlide()">
    ...
    <div id="slide4" class="carousel-item relative w-full">
        <div class="hero mx-6 md:mx-16 lg:mx-24 xl:mx-32">
            <div class="hero-content flex-col-reverse lg:flex-row-reverse">
                ...
                <img src="assets/slide/slide4.jpg" class="rounded-lg w-full md:w-1/2 lg:w-2/5 xl:w-1/2" alt="slide4" />
            </div>
        </div>
